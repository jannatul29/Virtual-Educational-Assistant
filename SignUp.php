...
<div class="signup">
  <h1 align="center" style="color:white;">Create account</h1>
   <form action="" method="post" style="text-align:center;">
        ...
        <input class="form-control" type="text" name="phn" placeholder="Phone number-BD" required pattern="01[3-9][0-9]{8}" required>
        <input class="form-control" type="password" name="pass" placeholder="Password-five char, at least one digit"  required pattern="^(?=.*\d)[A-Za-z\d]{5}$" required>
        <input class="form-control" type="text" name="ques" placeholder="Write your pet's name" required>
        <hr class="mb-2">
