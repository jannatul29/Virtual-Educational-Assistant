...
<div class="login">
<h3 align="center">Payment Using Card</h3>
<form action="" method="post" style="text-align:center;">

<div class="col-xs-5 col-lg-6 pl-ziro">
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-7">
                            <div class="form-group">
                                ...
                                <div class="col-xs-5 col-lg-6 pl-ziro">
                                    <input type="text" class="form-control" id="expityYear" placeholder="YY" name="exp_year" required /></div>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4 pull-right">
                            <div class="form-group">
                                <label for="cvCode">
                                    CV CODE</label>
                                <input type="password" class="form-control" id="cvCode" placeholder="CV" name="cvc" required />
                            </div>
                        </div>
                    </div>
                    <br/>
