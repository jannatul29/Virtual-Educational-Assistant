...
<nav class="navbar navbar-expand-sm navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <ul class="navbar-nav custom-nav pl-5">
      <li class= "nav-item custom-nav-item"><a href="admin_home.php" class="nav-link">Home </a></li>
      <?php
      if(isset($_SESSION['login_admin'])){
      
      echo '<li class= "nav-item custom-nav-item"><a href="profileA.php" class="nav-link">Profile</a></li>';}
      ?>
      <li class= "nav-item custom-nav-item"><a href="#" class="nav-link">Courses</a>
           <div class="sub-menu">
                <ul>
                    ...
                    <li class= "nav-item custom-nav-item"><a href="#" class="nav-link">Physics</a></li>
                </ul>
            </div>
      </li>
      <li class= "nav-item custom-nav-item"><a href="teacher_list.php" class="nav-link">Teachers</a></li>
      <li class= "nav-item custom-nav-item"><a href="student_list.php" class="nav-link">Students</a></li>
      <li class= "nav-item custom-nav-item"><a href="dashboard.php" class="nav-link">Dashboard</a></li>
      <li class= "nav-item custom-nav-item"><a href="feedback_show.php" class="nav-link">Feedback</a></li>
